...
pub mod get_world_info_out {
    ...
    impl ::protobuf::Enum for Mode {
        ...
        fn from_str(str: &str) -> ::std::option::Option<Mode> {
            match str {
                "MODE_DWARF" => ::std::option::Option::Some(Mode::MODE_DWARF),
                "MODE_ADVENTURE" => ::std::option::Option::Some(Mode::MODE_ADVENTURE),
                "MODE_LEGENDS" => ::std::option::Option::Some(Mode::MODE_LEGENDS),
                _ => ::std::option::Option::None
            }
        }
