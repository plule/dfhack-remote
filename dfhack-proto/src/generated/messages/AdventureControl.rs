...
impl ::protobuf::Enum for AdvmodeMenu {
    ...
    fn from_str(str: &str) -> ::std::option::Option<AdvmodeMenu> {
        match str {
            "Default" => ::std::option::Option::Some(AdvmodeMenu::Default),
            "Look" => ::std::option::Option::Some(AdvmodeMenu::Look),
            "ConversationAddress" => ::std::option::Option::Some(AdvmodeMenu::ConversationAddress),
            "ConversationSelect" => ::std::option::Option::Some(AdvmodeMenu::ConversationSelect),
            "ConversationSpeak" => ::std::option::Option::Some(AdvmodeMenu::ConversationSpeak),
            "Inventory" => ::std::option::Option::Some(AdvmodeMenu::Inventory),
            "Drop" => ::std::option::Option::Some(AdvmodeMenu::Drop),
            "ThrowItem" => ::std::option::Option::Some(AdvmodeMenu::ThrowItem),
            "Wear" => ::std::option::Option::Some(AdvmodeMenu::Wear),
            "Remove" => ::std::option::Option::Some(AdvmodeMenu::Remove),
            "Interact" => ::std::option::Option::Some(AdvmodeMenu::Interact),
            "Put" => ::std::option::Option::Some(AdvmodeMenu::Put),
            "PutContainer" => ::std::option::Option::Some(AdvmodeMenu::PutContainer),
            "Eat" => ::std::option::Option::Some(AdvmodeMenu::Eat),
            "ThrowAim" => ::std::option::Option::Some(AdvmodeMenu::ThrowAim),
            "Fire" => ::std::option::Option::Some(AdvmodeMenu::Fire),
            "Get" => ::std::option::Option::Some(AdvmodeMenu::Get),
            "Unk17" => ::std::option::Option::Some(AdvmodeMenu::Unk17),
            "CombatPrefs" => ::std::option::Option::Some(AdvmodeMenu::CombatPrefs),
            "Companions" => ::std::option::Option::Some(AdvmodeMenu::Companions),
            "MovementPrefs" => ::std::option::Option::Some(AdvmodeMenu::MovementPrefs),
            "SpeedPrefs" => ::std::option::Option::Some(AdvmodeMenu::SpeedPrefs),
            "InteractAction" => ::std::option::Option::Some(AdvmodeMenu::InteractAction),
            "MoveCarefully" => ::std::option::Option::Some(AdvmodeMenu::MoveCarefully),
            "Announcements" => ::std::option::Option::Some(AdvmodeMenu::Announcements),
            "UseBuilding" => ::std::option::Option::Some(AdvmodeMenu::UseBuilding),
            "Travel" => ::std::option::Option::Some(AdvmodeMenu::Travel),
            "Unk27" => ::std::option::Option::Some(AdvmodeMenu::Unk27),
            "Unk28" => ::std::option::Option::Some(AdvmodeMenu::Unk28),
            "SleepConfirm" => ::std::option::Option::Some(AdvmodeMenu::SleepConfirm),
            "SelectInteractionTarget" => ::std::option::Option::Some(AdvmodeMenu::SelectInteractionTarget),
            "Unk31" => ::std::option::Option::Some(AdvmodeMenu::Unk31),
            "Unk32" => ::std::option::Option::Some(AdvmodeMenu::Unk32),
            "FallAction" => ::std::option::Option::Some(AdvmodeMenu::FallAction),
            "ViewTracks" => ::std::option::Option::Some(AdvmodeMenu::ViewTracks),
            "Jump" => ::std::option::Option::Some(AdvmodeMenu::Jump),
            "Unk36" => ::std::option::Option::Some(AdvmodeMenu::Unk36),
            "AttackConfirm" => ::std::option::Option::Some(AdvmodeMenu::AttackConfirm),
            "AttackType" => ::std::option::Option::Some(AdvmodeMenu::AttackType),
            "AttackBodypart" => ::std::option::Option::Some(AdvmodeMenu::AttackBodypart),
            "AttackStrike" => ::std::option::Option::Some(AdvmodeMenu::AttackStrike),
            "Unk41" => ::std::option::Option::Some(AdvmodeMenu::Unk41),
            "Unk42" => ::std::option::Option::Some(AdvmodeMenu::Unk42),
            "DodgeDirection" => ::std::option::Option::Some(AdvmodeMenu::DodgeDirection),
            "Unk44" => ::std::option::Option::Some(AdvmodeMenu::Unk44),
            "Unk45" => ::std::option::Option::Some(AdvmodeMenu::Unk45),
            "Build" => ::std::option::Option::Some(AdvmodeMenu::Build),
            _ => ::std::option::Option::None
        }
    }
...
impl ::protobuf::Enum for CarefulMovementType {
    ...
    fn from_str(str: &str) -> ::std::option::Option<CarefulMovementType> {
        match str {
            "DEFAULT_MOVEMENT" => ::std::option::Option::Some(CarefulMovementType::DEFAULT_MOVEMENT),
            "RELEASE_ITEM_HOLD" => ::std::option::Option::Some(CarefulMovementType::RELEASE_ITEM_HOLD),
            "RELEASE_TILE_HOLD" => ::std::option::Option::Some(CarefulMovementType::RELEASE_TILE_HOLD),
            "ATTACK_CREATURE" => ::std::option::Option::Some(CarefulMovementType::ATTACK_CREATURE),
            "HOLD_TILE" => ::std::option::Option::Some(CarefulMovementType::HOLD_TILE),
            "MOVE" => ::std::option::Option::Some(CarefulMovementType::MOVE),
            "CLIMB" => ::std::option::Option::Some(CarefulMovementType::CLIMB),
            "HOLD_ITEM" => ::std::option::Option::Some(CarefulMovementType::HOLD_ITEM),
            "BUILDING_INTERACT" => ::std::option::Option::Some(CarefulMovementType::BUILDING_INTERACT),
            "ITEM_INTERACT" => ::std::option::Option::Some(CarefulMovementType::ITEM_INTERACT),
            "ITEM_INTERACT_GUIDE" => ::std::option::Option::Some(CarefulMovementType::ITEM_INTERACT_GUIDE),
            "ITEM_INTERACT_RIDE" => ::std::option::Option::Some(CarefulMovementType::ITEM_INTERACT_RIDE),
            "ITEM_INTERACT_PUSH" => ::std::option::Option::Some(CarefulMovementType::ITEM_INTERACT_PUSH),
            _ => ::std::option::Option::None
        }
    }
...
impl ::protobuf::Enum for MiscMoveType {
    ...
    fn from_str(str: &str) -> ::std::option::Option<MiscMoveType> {
        match str {
            "SET_CLIMB" => ::std::option::Option::Some(MiscMoveType::SET_CLIMB),
            "SET_STAND" => ::std::option::Option::Some(MiscMoveType::SET_STAND),
            "SET_CANCEL" => ::std::option::Option::Some(MiscMoveType::SET_CANCEL),
            _ => ::std::option::Option::None
        }
    }
