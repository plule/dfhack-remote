...
impl ::protobuf::Enum for PitchChoiceType {
    ...
    fn from_str(str: &str) -> ::std::option::Option<PitchChoiceType> {
        match str {
            "MEMBRANE_POSITION" => ::std::option::Option::Some(PitchChoiceType::MEMBRANE_POSITION),
            "SUBPART_CHOICE" => ::std::option::Option::Some(PitchChoiceType::SUBPART_CHOICE),
            "KEYBOARD" => ::std::option::Option::Some(PitchChoiceType::KEYBOARD),
            "STOPPING_FRET" => ::std::option::Option::Some(PitchChoiceType::STOPPING_FRET),
            "STOPPING_AGAINST_BODY" => ::std::option::Option::Some(PitchChoiceType::STOPPING_AGAINST_BODY),
            "STOPPING_HOLE" => ::std::option::Option::Some(PitchChoiceType::STOPPING_HOLE),
            "STOPPING_HOLE_KEY" => ::std::option::Option::Some(PitchChoiceType::STOPPING_HOLE_KEY),
            "SLIDE" => ::std::option::Option::Some(PitchChoiceType::SLIDE),
            "HARMONIC_SERIES" => ::std::option::Option::Some(PitchChoiceType::HARMONIC_SERIES),
            "VALVE_ROUTES_AIR" => ::std::option::Option::Some(PitchChoiceType::VALVE_ROUTES_AIR),
            "BP_IN_BELL" => ::std::option::Option::Some(PitchChoiceType::BP_IN_BELL),
            "FOOT_PEDALS" => ::std::option::Option::Some(PitchChoiceType::FOOT_PEDALS),
            _ => ::std::option::Option::None
        }
    }
...
impl ::protobuf::Enum for SoundProductionType {
    ...
    fn from_str(str: &str) -> ::std::option::Option<SoundProductionType> {
        match str {
            "PLUCKED_BY_BP" => ::std::option::Option::Some(SoundProductionType::PLUCKED_BY_BP),
            "PLUCKED" => ::std::option::Option::Some(SoundProductionType::PLUCKED),
            "BOWED" => ::std::option::Option::Some(SoundProductionType::BOWED),
            "STRUCK_BY_BP" => ::std::option::Option::Some(SoundProductionType::STRUCK_BY_BP),
            "STRUCK" => ::std::option::Option::Some(SoundProductionType::STRUCK),
            "VIBRATE_BP_AGAINST_OPENING" => ::std::option::Option::Some(SoundProductionType::VIBRATE_BP_AGAINST_OPENING),
            "BLOW_AGAINST_FIPPLE" => ::std::option::Option::Some(SoundProductionType::BLOW_AGAINST_FIPPLE),
            "BLOW_OVER_OPENING_SIDE" => ::std::option::Option::Some(SoundProductionType::BLOW_OVER_OPENING_SIDE),
            "BLOW_OVER_OPENING_END" => ::std::option::Option::Some(SoundProductionType::BLOW_OVER_OPENING_END),
            "BLOW_OVER_SINGLE_REED" => ::std::option::Option::Some(SoundProductionType::BLOW_OVER_SINGLE_REED),
            "BLOW_OVER_DOUBLE_REED" => ::std::option::Option::Some(SoundProductionType::BLOW_OVER_DOUBLE_REED),
            "BLOW_OVER_FREE_REED" => ::std::option::Option::Some(SoundProductionType::BLOW_OVER_FREE_REED),
            "STRUCK_TOGETHER" => ::std::option::Option::Some(SoundProductionType::STRUCK_TOGETHER),
            "SHAKEN" => ::std::option::Option::Some(SoundProductionType::SHAKEN),
            "SCRAPED" => ::std::option::Option::Some(SoundProductionType::SCRAPED),
            "FRICTION" => ::std::option::Option::Some(SoundProductionType::FRICTION),
            "RESONATOR" => ::std::option::Option::Some(SoundProductionType::RESONATOR),
            "BAG_OVER_REED" => ::std::option::Option::Some(SoundProductionType::BAG_OVER_REED),
            "AIR_OVER_REED" => ::std::option::Option::Some(SoundProductionType::AIR_OVER_REED),
            "AIR_OVER_FREE_REED" => ::std::option::Option::Some(SoundProductionType::AIR_OVER_FREE_REED),
            "AIR_AGAINST_FIPPLE" => ::std::option::Option::Some(SoundProductionType::AIR_AGAINST_FIPPLE),
            _ => ::std::option::Option::None
        }
    }
...
impl ::protobuf::Enum for TuningType {
    ...
    fn from_str(str: &str) -> ::std::option::Option<TuningType> {
        match str {
            "PEGS" => ::std::option::Option::Some(TuningType::PEGS),
            "ADJUSTABLE_BRIDGES" => ::std::option::Option::Some(TuningType::ADJUSTABLE_BRIDGES),
            "CROOKS" => ::std::option::Option::Some(TuningType::CROOKS),
            "TIGHTENING" => ::std::option::Option::Some(TuningType::TIGHTENING),
            "LEVERS" => ::std::option::Option::Some(TuningType::LEVERS),
            _ => ::std::option::Option::None
        }
    }
